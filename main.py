...
def parse_args():
    ...
    parser.add_argument('-i', '--image', type=str, default="input/colorized", help="Path to the folder containing raw manga images.")
    parser.add_argument('-j', '--json', type=str, default="input/json", help="Path to the folder containing JSON files with dialogue data.")
    parser.add_argument('-a', '--audio', type=str, default="input/audio", help="Path to the folder containing audio files.")
